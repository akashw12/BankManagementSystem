...
public class Withdraw extends JFrame {
    ...
    public Withdraw(JFrame transactionFrame, String cardNumber) {
            ...
            if (!amountText.isEmpty()) {
                try {
                    ...
                    if (amount <= 0) {
                        ...
                        // Call performWithdraw method with the amount to withdraw
                        boolean success = performWithdraw(amount);
                        if (success) {
                            JOptionPane.showMessageDialog(this, "Withdrawal Successful!");
                            setVisible(false); // Close the Withdraw frame
    ...
    // Withdraw logic using the card number and updating the database
    private boolean performWithdraw(double amount) {
        ...
        return isSuccess; // Return the result of the withdrawal operation
    }
}
